...
//    vertices[0] = mesh.add_vertex(pmp::Point(-1, -1, -1)); // 0
//    vertices[1] = mesh.add_vertex(pmp::Point(1, -1, -1));  // 1
//    vertices[2] = mesh.add_vertex(pmp::Point(1, 1, -1));   // 2
//    vertices[3] = mesh.add_vertex(pmp::Point(-1, 1, -1));  // 3
//    vertices[4] = mesh.add_vertex(pmp::Point(-1, -1, 1));  // 4
//    vertices[5] = mesh.add_vertex(pmp::Point(1, -1, 1));   // 5
//    vertices[6] = mesh.add_vertex(pmp::Point(1, 1, 1));    // 6
//    vertices[7] = mesh.add_vertex(pmp::Point(-1, 1, 1));   // 7
//
